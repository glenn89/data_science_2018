...
- 2.3.8 [신경망(딥러닝)](https://nbviewer.jupyter.org/github/glenn89/data_science_2018/blob/master/Chapter02/2.3.8.ipynb) (by 3/27) 
...
- 3.3.1 [여러 가지 전처리 방법](https://nbviewer.jupyter.org/github/glenn89/data_science_2018/blob/master/Chapter02/3.3.1.ipynb)
- 3.3.2 [데이터 변환 적용하기](https://nbviewer.jupyter.org/github/glenn89/data_science_2018/blob/master/Chapter02/3.3.2.ipynb)
- 3.3.3 [훈련 데이터와 테스트 데이터의 스케일을 같은 방법으로 조정하기](https://nbviewer.jupyter.org/github/glenn89/data_science_2018/blob/master/Chapter02/3.3.3.ipynb) 
- 3.3.4 [지도 학습에서 데이터 전처리 효과](https://nbviewer.jupyter.org/github/glenn89/data_science_2018/blob/master/Chapter02/3.3.4.ipynb) (by 4/10)
